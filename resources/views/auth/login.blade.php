...
@section('content')
<div class="container">
    <div style="direction: rtl;" class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" style="display: flex;justify-content: end;" for="remember">
                                        {{ __('ذكرني') }}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" style="background: #018783; color:#fff" class="btn">
                                    {{ __('تسجيل الدخول') }}
                                </button>
